...
for tile in 64 12 14 68 13 15 66 69 26 67 91 16 36 29 71 82 32 40; do
	...
	./pso -n $tile -m ../../motif_library/d1_vitruvian.json -l energized_$tile -u $du -e 0.001 -a 25.0 -g $du;
	cat energized_"$tile"_*.xyz >> energized_"$tile".xyz; # Summarize the results

	# No interaction between tile and motif
	./pso -n $tile -m ../../motif_library/d1_vitruvian.json -l deenergized_$tile -u $du -e 0.0 -a 25.0 -g $du;
